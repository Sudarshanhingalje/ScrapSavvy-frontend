...
const InTransitPage = () => {
  ...
  const filtered = deliveries.filter((d) => d.deliveryStatus === "IN_TRANSIT");
  ...
  return (
    <div className="delivery-layout">
      ...
      <div className="delivery-management-container">
        ...
        <h1 className="delivery-management-title">🛣️ In Transit Orders</h1>
        ...
        >
          {filtered.length} order(s) are currently in transit.
        </div>
        ...
        {!loading && !error && filtered.length === 0 && (
          <div className="delivery-empty">
            ...
            <div>No orders in transit right now</div>
          </div>
        )}
